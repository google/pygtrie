...
class Trie(_collections.MutableMapping):
    ...
    def has_node(self, key):
        ...
        Returns:
            A bitwise or of ``HAS_VALUE`` and ``HAS_SUBTRIE`` values indicating
            that node has a value associated with it and that it is a prefix of
            another existing key respectively.
        """
        try:
